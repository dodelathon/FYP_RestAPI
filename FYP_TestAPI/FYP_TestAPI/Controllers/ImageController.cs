    ...
    public class ImageController : ControllerBase
    {
        ...
        public async Task<IActionResult> RecieveImage([FromForm]Image recieved)
        {
            ...
            try
            {
                ...
                {
                    return StatusCode(StatusCodes.Status406NotAcceptable, "Does not exist: " + _context.Exists(recieved._Device, ConnectedDevicesContext.DatabaseGetMode.UUID) + " " + recieved._Device + " or length is unsuitable: " + actual_Picture.Length);
                }
            }
